...
return [
    ...
    */
    ...
    'component_namespaces' => [
        ...
        'modals'     => resource_path('views/livewire/modals'),
    ...
    */
    ...
    'make_command' => [
     ...
     /*
    |--------------------------------------------------------------------------
    | Blaze (Rendering Engine)
    |--------------------------------------------------------------------------
    | Blaze adalah rendering engine baru Livewire 4.
    | Pre-compile bagian statis template saat compile time → 3x-20x lebih cepat.
    | SELALU aktifkan di production.
    |
    */
    'blaze' => [
        'enabled' => true,
